<section id="one-parallax" class="parallax" style="background-image: url('<?=base_url()?>assets/img/cabeceras/ebora_1200x800.jpg');"
                            ...
                            <div class="flexslider">
                                <ul class="slides">
                                    <li>
                                        ...
                                        <a href="#"><img src="<?=base_url()?>assets/demos/02_slider.png" alt=""></a>
                                    </li>
                                    <li>
                                        <div class="desc">
                                            <div class="ps-desc">
                                        ...
                                        <a href="#"><img src="<?=base_url()?>assets/demos/01_slider.png" alt=""></a>
                                    </li>
                                    <li>
                                        <div class="desc">
                                            <div class="ps-desc">
                                        ...
                                        <a href="#"><img src="<?=base_url()?>assets/demos/03_slider.png" alt=""></a>
                                    </li>
                                </ul><!-- end slides -->
                            </div><!-- end flexslider -->
...
<section id="three-parallax" class="parallax" style="background-image: url('<?=base_url()?>assets/img/cabeceras/ebora_1200x800.jpg');"
         data-stellar-background-ratio="0.6" data-stellar-vertical-offset="20">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="boxes first" data-effect="slide-bottom">
                            <div class="ImageWrapper boxes_img">
                                <img class="img-responsive" src="<?=base_url()?>assets/demos/01_home.jpg" alt="">
                                <div class="ImageOverlayH"></div>
                                <div class="Buttons StyleSc">
                                                <span class="WhiteSquare">
                                                    <a class="fancybox" href="<?=base_url()?>assets/demos/01_home.jpg">
                                                        <i class="fa fa-search"></i></a>
                                                </span>
                                    <span class="WhiteSquare"><a class="fancybox" data-type="iframe"
                                                                 href="http://player.vimeo.com/video/64550407?autoplay=1">
                            ...
                            <h2 class="title"><a href="single-property.html"> Home of your dreams</a>
                                <small class="small_title">2307 New York City</small></h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="boxes" data-effect="slide-bottom">
                            <div class="ImageWrapper boxes_img">
                                <img class="img-responsive" src="<?=base_url()?>assets/demos/02_home.jpg" alt="">
                                <div class="ImageOverlayH"></div>
                                <div class="Buttons StyleMg">
                                                <span class="WhiteSquare">
                                                    <a class="fancybox" href="<?=base_url()?>assets/demos/02_home.jpg">
                                                        <i class="fa fa-search"></i></a>
                                                </span>
                                    <span class="WhiteSquare"><a href="single-property.html"><i class="fa fa-link"></i></a>
                                                </span>
                            ...
                            <h2 class="title"><a href="single-property.html"> A Family Home for all your needs</a>
                                <small class="small_title">890 Istanbul / Maslak</small></h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="boxes" data-effect="slide-bottom">
                            <div class="ImageWrapper boxes_img">
                                <img class="img-responsive" src="<?=base_url()?>assets/demos/03_home.jpg" alt="">
                                <div class="ImageOverlayH"></div>
                                <div class="Buttons StyleMg">
                                                <span class="WhiteSquare"><a class="fancybox"
                                                                             href="<?=base_url()?>assets/demos/03_home.jpg">
                                                        <i class="fa fa-search"></i></a>
                                                </span>
                                    <span class="WhiteSquare"><a href="single-property.html"><i class="fa fa-link"></i></a>
                                                </span>
                            ...
                            <h2 class="title"><a href="single-property.html"> Complete Apertment (1 Year)</a>
                                <small class="small_title">50/7 Amsterdam / HOLLAND</small></h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="boxes last" data-effect="slide-bottom">
                            <div class="ImageWrapper boxes_img">
                                <img class="img-responsive" src="<?=base_url()?>assets/demos/04_home.jpg" alt="">
                                <div class="ImageOverlayH"></div>
                                <div class="Buttons StyleMg">
                                                <span class="WhiteSquare"><a class="fancybox"
                                                                             href="<?=base_url()?>assets/demos/04_home.jpg">
                                                        <i class="fa fa-search"></i></a>
                                                </span>
                                    <span class="WhiteSquare"><a href="single-property.html"><i class="fa fa-link"></i></a>
                                                </span>
                            ...
                            <h2 class="title"><a href="single-property.html"> Grand Triplex (Limited time)</a>
                                <small class="small_title">1508 Bodrum / TURKEI</small></h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="boxes first" data-effect="slide-bottom">
                            <div class="ImageWrapper boxes_img">
                                <img class="img-responsive" src="<?=base_url()?>assets/demos/06_home.png" alt="">
                                <div class="ImageOverlayH"></div>
                                <div class="Buttons StyleMg">
                                                <span class="WhiteSquare"><a class="fancybox"
                                                                             href="<?=base_url()?>assets/demos/06_home.png">
                                                        <i class="fa fa-search"></i></a>
                                                </span>
                                    <span class="WhiteSquare"><a href="single-property.html"><i class="fa fa-link"></i></a>
                                                </span>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="boxes" data-effect="slide-bottom">
                            <div class="ImageWrapper boxes_img">
                                <img class="img-responsive" src="<?=base_url()?>assets/demos/07_home.png" alt="">
                                <div class="ImageOverlayH"></div>
                                <div class="Buttons StyleMg">
                                                <span class="WhiteSquare"><a class="fancybox"
                                                                             href="<?=base_url()?>assets/demos/07_home.png">
                                                        <i class="fa fa-search"></i></a>
                                                </span>
                                    <span class="WhiteSquare"><a href="single-property.html"><i class="fa fa-link"></i></a>
                                                </span>
                            ...
                            <h2 class="title"><a href="single-property.html"> Creative & Modern Family House</a>
                                <small class="small_title">120/79 ST Antalya / TURKEI</small></h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="boxes" data-effect="slide-bottom">
                            <div class="ImageWrapper boxes_img">
                                <img class="img-responsive" src="<?=base_url()?>assets/demos/08_home.png" alt="">
                                <div class="ImageOverlayH"></div>
                                <div class="Buttons StyleMg">
                                                <span class="WhiteSquare"><a class="fancybox"
                                                                             href="<?=base_url()?>assets/demos/08_home.png">
                                                        <i class="fa fa-search"></i></a>
                                                </span>
                                    <span class="WhiteSquare"><a href="single-property.html"><i class="fa fa-link"></i></a>
                                                </span>
                            ...
                            <h2 class="title"><a href="single-property.html"> 2 Week Holland Travel</a>
                                <small class="small_title">21/22 Hanue / Germany</small></h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="boxes last" data-effect="slide-bottom">
                            <div class="ImageWrapper boxes_img">
                                <img class="img-responsive" src="<?=base_url()?>assets/demos/09_home.png" alt="">
                                <div class="ImageOverlayH"></div>
                                <div class="Buttons StyleSc">
                                                <span class="WhiteSquare"><a class="fancybox"
                                                                             href="<?=base_url()?>assets/demos/09_home.png">
                                                        <i class="fa fa-search"></i></a>
                                                </span>
                                    <span class="WhiteSquare"><a class="fancybox" data-type="iframe"
                                                                 href="http://player.vimeo.com/video/64550407?autoplay=1">
                            ...
                            <h2 class="title"><a href="single-property.html"> House in New York City</a>
                                <small class="small_title">980 Roterdam / Holland</small></h2>
        ...
        <div class="row">
                        ...
                        <div class="tab-pane active" id="tab">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?=base_url()?>assets/demos/05_home.png" alt="">
                                            <div class="PStyleNe"></div>
                                        </a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-9 col-xs-12 last clearfix">
                <div class="widget clearfix">
                    <div class="agents_widget">
                        ...
                        <div class="agent boxes clearfix" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" src="<?=base_url()?>assets/demos/01_team.png" alt="">
                            </div><!-- image -->
                        ...
                        <div class="agent boxes clearfix" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" src="<?=base_url()?>assets/demos/02_team.png" alt="">
                            </div><!-- image -->
                            <div class="agent_desc">
                        ...
                        <div class="agent boxes clearfix" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" src="<?=base_url()?>assets/demos/03_team.png" alt="">
                            </div><!-- image -->
                            <div class="agent_desc">
                        ...
                        <div class="agent boxes clearfix" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" src="<?=base_url()?>assets/demos/04_team.png" alt="">
                            </div><!-- image -->
                            <div class="agent_desc">
                ...
                <div class="widget text-center clearfix">
                    <img data-effect="fade" class="img-thumbnail img-responsive" src="<?=base_url()?>assets/demos/01_banner.png" alt="">
                </div><!-- end of widget -->
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
    </div><!-- end dm_container -->
...
<section id="two-parallax" class="parallax" style="background-image: url('<?=base_url()?>assets/img/cabeceras/ebora_1200x800.jpg');" data-stellar-background-ratio="0.6" data-stellar-vertical-offset="20">
    <div class="threewrapper">
        <div class="overlay1 dm-shadow">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="boxes testimonial_widget text-right first" data-effect="slide-left">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" alt="" src="<?=base_url()?>assets/demos/03_team.png">
                            </div>
                            <div class="testimonial_desc">
                                <h3 class="title">Mark ANTHONY</h3>
                                <p><i class="fa fa-quote-left"></i> Gehad van wijzigingen in een of andere vorm, door ingevoegde
                                    humor of willekeurig gekozen woorden die nog niet half geloofwaardig ogen..
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="boxes testimonial_widget text-left last" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" alt="" src="<?=base_url()?>assets/demos/02_team.png">
                            </div>
                            <div class="testimonial_desc">
                                <h3 class="title">Sandra ROBERTS</h3>
                                <p><span><i class="fa fa-quote-left"></i></span> Vele variaties van passages van Lorem Ipsum
                                    beschikbaar maar het merendeel heeft te lijden gehad van wijzigingen in een of andere vorm,
                                    door ingevoegde humor of willekeurig gekozen woorden die nog niet half geloofwaardig ogen.
                                    <i class="fa fa-quote-right"></i></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="boxes testimonial_widget text-right first" data-effect="slide-left">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" alt="" src="<?=base_url()?>assets/demos/04_team.png">
                            </div>
                            <div class="testimonial_desc">
                                <h3 class="title">Amy JOHNSON</h3>
                                <p><i class="fa fa-quote-left"></i> Lorem ipsum dehad van wijzigingen in een of andere vorm, door
                                    ingevoegde humor of willekeurig gekozen woorden die nog niet half ogen..
                                    <i class="fa fa-quote-right"></i></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="boxes testimonial_widget text-left last" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" alt="" src="<?=base_url()?>assets/demos/01_team.png">
                            </div>
                            <div class="testimonial_desc">
                                <h3 class="title">Robert PIRSON</h3>
                                <p><span><i class="fa fa-quote-left"></i></span> Vele variaties van passages van Lorem Ipsum
                                    beschikbaar maa, door ingevoegde humor of willekeurig gekozen woorden die nog niet half
                ...
                <div id="slider" class="flexslider">
                    <ul class="slides">
                        <li>
                            ...
                            <img class="img-thumbnail" src="<?=base_url()?>assets/demos/01_home.jpg" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                                <span class="type">Villa</span>
                            ...
                            <img class="img-thumbnail" src="<?=base_url()?>assets/demos/02_home.jpg" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                            ...
                            <img class="img-thumbnail" src="<?=base_url()?>assets/demos/03_home.jpg" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                                <span class="type">Family Home</span>
                            ...
                            <img class="img-thumbnail" src="<?=base_url()?>assets/demos/04_home.jpg" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                            ...
                            <img class="img-thumbnail" src="<?=base_url()?>assets/demos/05_home.png" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                                <span class="type">Family Home</span>
                            ...
                            <img class="img-thumbnail" src="<?=base_url()?>assets/demos/06_home.png" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                            ...
                            <img class="img-thumbnail" src="<?=base_url()?>assets/demos/07_home.png" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                                <span class="type">Apertment</span>
                            ...
                            <img class="img-thumbnail" src="<?=base_url()?>assets/demos/08_home.png" alt="">
                        </li>
                    </ul>
                </div>
                <div id="carousel" class="flexslider">
                    <ul class="slides">
                        <li><img class="img-thumbnail" src="<?=base_url()?>assets/demos/01_home.jpg" alt=""></li>
                        <li><img class="img-thumbnail" src="<?=base_url()?>assets/demos/02_home.jpg" alt=""></li>
                        <li><img class="img-thumbnail" src="<?=base_url()?>assets/demos/03_home.jpg" alt=""></li>
                        <li><img class="img-thumbnail" src="<?=base_url()?>assets/demos/04_home.jpg" alt=""></li>
                        <li><img class="img-thumbnail" src="<?=base_url()?>assets/demos/05_home.png" alt=""></li>
                        <li><img class="img-thumbnail" src="<?=base_url()?>assets/demos/06_home.png" alt=""></li>
                        <li><img class="img-thumbnail" src="<?=base_url()?>assets/demos/07_home.png" alt=""></li>
                        <li><img class="img-thumbnail" src="<?=base_url()?>assets/demos/08_home.png" alt=""></li>
                    </ul>
                </div>
            </div><!-- end col6 -->
...
<section id="four-parallax" class="parallax" style="background-image: url('<?=base_url()?>assets/img/cabeceras/ebora_1200x800.jpg');"
         data-stellar-background-ratio="0.6" data-stellar-vertical-offset="20">
    <div class="overlay1 dm-shadow">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="boxes agencies_widget first" data-effect="slide-bottom">
                        <div class="col-lg-3">
                            <div class="image">
                                <img class="img-responsive img-thumbnail" src="<?=base_url()?>assets/demos/agencies_logo.png" alt="">
                            </div><!-- end agencies img -->
                        </div>
                        <div class="col-lg-9">
                            <div class="agencies_desc">
                                <h3 class="title">NYC Real Estate Group</h3>
                                <p>Vele variaties van passages van Lorem Ipsum beschikbaar maar het merendeel heeft te lijden gehad van
                                    wijzigingen in een of andere vorm...</p>
                                <a href="#" class="btn btn-primary btn-sm">About Agencie</a>
                                <a href="#" class="btn btn-primary btn-sm">Assigned Properties</a>
                    ...
                    <div class="boxes agencies_widget last">
                        ...
                        <div class="col-lg-9">
                            <div class="agencies_desc">
                                ...
                                <p>Vele variaties van passages van Lorem Ipsum beschikbaar maar het merendeel heeft te lijden
                                    gehad van wijzigingen in een of andere vorm...</p>
                                <a href="#" class="btn btn-primary btn-sm">About Agencie</a>
                                <a href="#" class="btn btn-primary btn-sm">Assigned Properties</a>
