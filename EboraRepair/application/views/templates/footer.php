    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-md-6">
                <p><small>Ebora Repair <?=date('Y')?>. Todos los derechos reservados. Diseño:
                        Diseño: <a href="mailto:wololab.dev@gmail.com">Wololab Development.</a><!--TODO add link to the official web site-->
                    </small></p>
            </div>
            <div class="col-lg-6 col-sm-6 col-md-6">
                <div class="social clearfix pull-right">
                    <span><a data-placement="top" data-toggle="tooltip" data-original-title="Twitter" title="EboraRepair Twitter" href="#">
                            <i class="fa fa-twitter"></i></a></span>
                    <span><a data-placement="top" data-toggle="tooltip" data-original-title="Facebook" title="EboraRepair Facebook" href="#">
